...
class TestNfvNsRealtimeR4(unittest.TestCase):

    def setUp(self):
        self.get_nsr_config = endpoints_s.NS_C_NSS_R4
        self.post_nsr_instantiate = endpoints_s.NS_INSTANTIATE_R4
        self.delete_nsr = endpoints_s.NS_DELETE_R4
        self.get_nsr_running = endpoints_s.NS_R_NSS_R4
